...
const [name, setName] = useState('Fight club');
...
{/* ===================================================================================
 ...
 <div className='holderposterv2'>

 <div  ref={FCref} className='PosterbgV2'  >
 <div className='posterOverley1'></div>
 <div className='psTextHolder'>
    <h1 className='V2posterTitile' >{name}</h1>
 </div>
</div>
